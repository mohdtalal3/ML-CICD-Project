...
def main():
    ...
    model = Perceptron(input_dim=input_dim, learning_rate=learning_rate, epochs=epochs)
    ...
    metrics = {
        ...
        "trained_weights": model.weights.tolist(),  # Convert numpy array to list for JSON compatibility
